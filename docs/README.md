...
Roles and personas are explicit and cross-functional. The **Project Manager (PM)** coordinates delivery, schedules, risks, dependencies, and communications. The **Product Manager (PdM / Product Lead)** defines outcomes, prioritizes the backlog, and measures success. The **Business Analyst (BA)** bridges stakeholders and the delivery team by gathering and documenting requirements and acceptance criteria. **Developers** design, build, and test features while participating in estimation and reviews. The **QA Lead** defines quality standards, plans and executes test cycles, and provides sign-off before releases. The **Release Manager** owns the end-to-end release process, coordinates deployment activities, and ensures all stakeholders are informed at release time. The **Stakeholder Liaison** acts as the single point of contact for external stakeholder communication and feedback. Each project has a named PM and Product Lead to ensure clear ownership across every phase of the lifecycle.
...
| [RACI Matrix](octoacme-roles-and-personas-raci.md) | Responsibility assignments (R/A/C/I) for core activities across all phases |
| [Handoff Checklist](octoacme-handoff-checklist.md) | Phase-to-phase and cross-functional handoff expectations and checklists |
